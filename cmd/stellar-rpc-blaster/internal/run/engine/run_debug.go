...
// 	// 3... 2... 1...
// 	debugCounters := map[string]*DebugRequestCounter{} // DEBUG
// 	var endpointBlasts []endpointBlast
// 	for _, endpointKey := range cfg.GetEndpoints() {
// 		rps := cfg.GetEndpointRPS(endpointKey)
// 		ep := cfg.Endpoints[endpointKey]

// 		counter := &DebugRequestCounter{} // DEBUG
// 		debugCounters[endpointKey] = counter
...
// 				}
// 			}
// 			DebugAnalyzeBodies(logger, endpointKey, bodies) // DEBUG
// 			targeter = wrapTargeterWithCounter(NewRotatingJSONRPCTargeter(cfg.RpcUrl, bodies), counter) // DEBUG: wrapped
...
// 			}
// 			targeter = wrapTargeterWithCounter(NewJSONRPCTargeter(cfg.RpcUrl, body), counter) // DEBUG: wrapped
// 		}
...
// 	// DEBUG: print how many requests each endpoint actually fired
// 	DebugPrintFireCounts(logger, debugCounters, cfg.Duration.Seconds())
